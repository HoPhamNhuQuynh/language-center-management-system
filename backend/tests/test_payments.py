...
class TestPaymentModule:
    ...
    def test_UTL_001_create_payment_returns_vnpay_payment_url(self, api_client, active_user, classroom):
    ...
    def test_UTL_002_vnpay_ipn_callback_updates_payment_and_enrollment_to_success(self, api_client, vnp_code, final_payment_status, final_enroll_status):
    ...
    def test_UTL_003_create_payment_amount_validation(self, api_client, active_user, classroom, amount, expected_status):
    ...
    def test_UTL_004_create_payment_returns_momo_pay_url(self, api_client, active_user, classroom): # cần check lại momo 
    ...
    def test_UTL_005_vnpay_callback_returns_failure_message_when_response_code_not_success(self, api_client):
    ...
    def test_UTL_007_vnpay_ipn_sets_payment_failed_when_response_code_not_success(self, api_client):
    ...
    def test_UTL_008_vnpay_ipn_returns_not_found_response_when_payment_not_exist(self, api_client):
    ...
    #Bổ sung
    def test_UTL_009_create_payment_returns_400_when_amount_missing(self, api_client, active_user, classroom):
    ...
    def test_UTL_010_create_payment_returns_200_when_amount_is_full_course_price(self, api_client, active_user, classroom):
