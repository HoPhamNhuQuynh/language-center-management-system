...
describe("manageService", () => {
  ...
  describe("getDashboardApi", () => {
    it("gọi đúng endpoint với year và quarter", async () => {
  ...
  // --- Courses ---
  describe("getCourses", () => {
    it("gọi đúng endpoint danh sách courses", async () => {
  ...
  describe("getLevels", () => {
    it("gọi đúng endpoint danh sách levels", async () => {
  ...
  describe("createCourse", () => {
    it("gọi đúng endpoint tạo course", async () => {
  ...
  describe("updateCourse", () => {
    it("gọi đúng endpoint update course", async () => {
  ...
  describe("deleteCourse", () => {
    it("gọi đúng endpoint xóa course", async () => {
  ...
  describe("createClass", () => {
    it("gọi đúng endpoint tạo class", async () => {
  ...
  describe("updateClass", () => {
    it("gọi đúng endpoint update class", async () => {
  ...
  describe("deleteClass", () => {
    it("gọi đúng endpoint xóa class", async () => {
      Apis.delete.mockResolvedValue({ data: { success: true } });
  ...
  describe("getTeachers", () => {
    it("gọi đúng endpoint danh sách teachers", async () => {
  ...
  describe("getRooms", () => {
    it("gọi đúng endpoint danh sách rooms", async () => {
  ...
  describe("createSession", () => {
    it("gọi đúng endpoint tạo session", async () => {
  ...
  describe("updateSession", () => {
    it("gọi đúng endpoint update session", async () => {
  ...
  describe("deleteSession", () => {
    it("gọi đúng endpoint xóa session", async () => {
      Apis.delete.mockResolvedValue({ data: { success: true } });
  ...
  // --- Users ---
  describe("getUsers", () => {
    it("gọi đúng endpoint với page mặc định là 1", async () => {
  ...
  describe("updateUser", () => {
    it("gọi đúng endpoint update user", async () => {
  ...
  describe("lockUser", () => {
    it("gọi đúng endpoint toggle lock user", async () => {
  ...
  describe("changeUserRole", () => {
    it("gọi đúng endpoint thay đổi role", async () => {
  ...
  describe("createTeacher", () => {
    it("gọi đúng endpoint tạo teacher", async () => {
