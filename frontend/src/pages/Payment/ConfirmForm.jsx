...
function ConfirmForm({ data = {}, method, percent, onSubmit, onCancel, onClose }) {
    ...
    <div style={{ display: "flex", justifyContent: "center", marginTop: 40 }}>
      <Card style={{ width: 700, borderRadius: 20 }}>
        <div style={{ display: "flex", alignItems: "center", border: "1px solid #ccc", 
          borderRadius: 10, padding: "10px 0", textAlign: "center", marginBottom: 20, background: "#1a1059" }}>
          <div style={{ width: 32 }} />
          <div style={{ flex: 1 }}>
            <h2 style={{ margin: 0, color: "#ffff"}}>XÁC NHẬN</h2>
          </div>

          <Button type="text" icon={<CloseOutlined />} onClick={onClose} style={{ color: "#ffffff" }}/>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "right",gap: 15, marginTop: 25 }}>
          <Button style={{ fontWeight: "bold" }} onClick={onCancel}>HỦY</Button>
          <Button style={{ background: "#1a1059",  fontWeight: "bold" }} type="primary" onClick={onSubmit} >THANH TOÁN</Button>
        </div>
