  ...
  return (
    <div className="student-info-layout">
      ...
      <main className="student-info-main">
        <div className="student-info-topbar">
          <h1 className="student-info-topbar__title">THÔNG TIN HỌC VIÊN</h1>

          <div className="student-info-userbox">
            <div>
              <p>
            ...
            <button className="student-info-logout-btn">ĐĂNG XUẤT</button>
          </div>
        </div>
