    ...
    <div style={{ width: "100%", background: "#fff" }}>
      <Card style={{ borderRadius: 20 }} bodyStyle={{ padding: 0 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: 15, 
          borderBottom: "1px solid #4c4c4c", background: "#191970", position: "relative" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 28, fontWeight: "bold", 
            color: "#ffffff" }}>
            <img src={logoImg} alt="logo" style={{ width: 40, height: 40 }} />
            LOGO
          </div>
          <div style={{ position: "absolute", left: "50%", transform: "translateX(-50%)", display: "flex", gap: 20 }}>
            <Link to="/home" style={{ padding: "6px 14px", borderRadius: 8, fontWeight: 500,
              textDecoration: "none", color: "#ffffff" }}>
              Trang chủ
            </Link>
            <Link to="/" style={{ padding: "6px 14px", borderRadius: 8, fontWeight: 500, 
              textDecoration: "none", color: "#ffffff" }}>
              About us
            </Link>
            <Link to="/courses" style={{ padding: "6px 14px", borderRadius: 8, fontWeight: 500, 
              textDecoration: "none", color: "#ffffff" }}>
              Chương trình
            </Link>
          </div>
          <div style={{ display: "flex", gap: 10 }}>
            <Link to="/login">
              <Button style={{ borderRadius: 8, minWidth: 100 }}>Đăng nhập</Button>
            </Link>
            <Link to="/register">
              <Button type="primary" style={{ borderRadius: 8, minWidth: 100 }}>
                Đăng ký
              </Button>
            </Link>
          </div>
