...
function PaymentForm({ data, method, setMethod, percent, setPercent, onSubmit }) {
    ...
    <div style={{ display: "flex", justifyContent: "center", marginTop: 40 }}>
      <Card style={{ width: 700, borderRadius: 20 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 30, paddingBottom: 15, borderBottom: "1px solid #eee" }}>
          <div style={{ fontSize: 28, fontWeight: "bold", color: "#1677ff" }}>LOGO</div>
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            ...
            <Link to="/">
              <Button style={{ borderRadius: 8, minWidth: 100 }}>Đăng xuất</Button>
            </Link>
          </div>
        </div>
