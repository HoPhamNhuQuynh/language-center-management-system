...
- Tên đề tài: Hệ Thống Quản Lý Trung Tâm Ngoại Ngữ (Language Center)
...
### Phân hệ Giáo viên/Trợ giảng (Teacher/Teaching Assistant)
...
- Frontend: ReactJS
- Database: MySQL
- AI (nếu có): OpenAI API (dự kiến dùng cho chatbot hỗ trợ người dùng)
