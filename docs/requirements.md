...
| Main Flow | 1. Admin truy cập chức năng Quản lý khóa học<br>2. Hệ thống hiển thị danh sách khóa học<br>3. Admin chọn khóa học cần sắp xếp lịch học<br>4. Hệ thống hiển thị các lớp có trong danh sách<br>5. Admin chọn lớp học cần sắp xếp<br>6. Hệ thống hiển thị thông tin chi tiết: mã lớp, tên lớp, khóa học, trạng thái hoạt động<br>7. Admin nhấn “Thêm”<br>8. Hệ thống hiển thị form nhập: ngày học, thời gian bắt đầu, thời gian kết thúc, phòng học, giáo viên<br>9. Admin nhập thông tin buổi học<br>10. Admin chọn ca cho lớp học<br>11. Admin nhấn “Lưu”<br>12. Hệ thống kiểm tra dữ liệu:<br>   - Không để trống thông tin<br>   - Thời gian kết thúc lớn hơn thời gian bắt đầu<br>13. Hệ thống kiểm tra trùng lịch:<br>   - Phòng học không được trùng trong cùng khung giờ<br>   - Giáo viên không được trùng lịch dạy<br>14. Nếu hợp lệ, hệ thống lưu buổi học<br>15. Hệ thống thông báo “Hoàn tất”<br>16. Hệ thống cập nhật danh sách buổi học của lớp<br>17. Hệ thống hiển thị buổi học vừa thêm<br>18. Admin tiếp tục thêm buổi học khác<br>19. Hệ thống cập nhật lịch học lên hệ thống đăng ký |
| Alternative Flow | A1. Cập nhật buổi học:<br>1. Admin chọn buổi học<br>2. Admin chọn “Cập nhật”<br>3. Hệ thống hiển thị form chỉnh sửa<br>4. Admin cập nhật thông tin<br>5. Admin nhấn “Lưu”<br>6. Hệ thống cập nhật<br>7. Hệ thống thông báo “Cập nhật thành công”<br><br>A2. Xóa buổi học:<br>1. Admin chọn buổi học<br>2. Admin chọn “Xóa”<br>3. Hệ thống hiển thị xác nhận<br>4. Admin xác nhận<br>5. Hệ thống xóa buổi học<br>6. Hệ thống cập nhật danh sách<br>7. Hệ thống thông báo “Xóa thành công” |
| Exception Flow | 1. Thiếu thông tin → “Vui lòng nhập đầy đủ thông tin”, quay lại bước nhập<br>2. Thời gian không hợp lệ → “Thời gian không hợp lệ”, quay lại bước nhập<br>3. Phòng học trùng → “Phòng học đã được sử dụng”, quay lại bước nhập<br>4. Giáo viên trùng lịch → “Giáo viên có lịch dạy trong thời gian này”, quay lại bước nhập |
...
| Pre-Condition(s) | Admin đã đăng nhập hệ thống<br>Hệ thống đã tồn tại các khóa học |
| Post-Condition(s) | Học phí được cập nhật và áp dụng khi đăng ký khóa học |
| Main Flow | 1. Admin truy cập chức năng Cấu hình học phí<br>2. Hệ thống hiển thị danh sách khóa học<br>3. Admin chọn khóa học cần cấu hình<br>4. Hệ thống hiển thị thông tin học phí<br>5. Admin nhập học phí<br>6. Admin nhấn “Lưu”<br>7. Hệ thống kiểm tra dữ liệu<br>8. Hệ thống lưu vào cơ sở dữ liệu<br>9. Hệ thống thông báo “Cập nhật thành công” |
| Alternative Flow | 1. Admin nhấn “Hủy”<br>2. Hệ thống hiển thị xác nhận<br>3. Admin chọn “Có”<br>4. Hệ thống quay lại danh sách |
| Exception Flow | 1. Học phí không hợp lệ → “Vui lòng nhập học phí hợp lệ”, quay lại bước nhập |
---
## 8.3. ERD Diagram
