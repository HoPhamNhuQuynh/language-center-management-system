...
| Main Flow | <ol> <li>Admin truy cập chức năng Cấu hình học phí.</li> <li>Hệ thống hiển thị danh sách các khóa học, các phương thức thanh toán, chính sách học phí.</li> <li>Admin chọn “Thiết lập chính sách”.</li> <li>Hệ thống hiển thị giao diện ghi.</li> <li>Admin nhập chính sách học phí áp dụng cho toàn hệ thống: <ul> <li>Học phí tối thiểu 2.000.000 VNĐ.</li> <li>Bắt buộc thanh toán toàn bộ các khóa học dưới 5.000.000 VNĐ.</li> <li>Cho phép thanh toán 50% các khóa học trên 5.000.000 VNĐ và thanh toán phần còn lại trước khai giảng 3 ngày.</li> </ul> </li> <li>Admin nhấn “Lưu”.</li> <li>Hệ thống lưu và quay lại giao diện chính.</li> <li>Admin nhấn “Thêm phương thức thanh toán”.</li> <li> Admin cấu hình chính sách thanh toán: <ul> <li>Thanh toán qua ngân hàng.</li> <li>Thanh toán qua ví điện tử (Momo, Zalopay, Shopeepay).</li> <li>Thanh toán qua thẻ tín dụng/ghi nợ.</li> </ul> </li> <li>Admin nhấn “Lưu”.</li> <li>Hệ thống lưu và quay lại giao diện chính.</li> <li>Admin chọn khóa học cần thiết lập học phí.</li> <li>Hệ thống hiển thị thông tin: mã khóa học, tên khóa học, học phí, phương thức thanh toán.</li> <li>Admin chọn nút “Thiết lập”.</li> <li>Admin nhập mức học phí.</li> <li>Admin nhấn “Lưu”.</li> <li>Hệ thống kiểm tra dữ liệu hợp lệ.</li> <li>Hệ thống lưu học phí vào hệ thống.</li> </ol>
| Alternative Flow | 7a. Admin chọn chính sách sẵn có, nhấn “Thay đổi”.<br>Usecase tiếp tục từ bước 5 đến bước 7.<br>11a. Admin chọn phương thức thanh toán đã có, nhấn “Ẩn”.<br>-Hệ thống hiển thị thông báo “Ẩn phương thức thanh toán?”.<br>-Admin nhấn “Xác nhận”<br>-Hệ thống ẩn phương thức thanh toán và hiển thị “Đã ẩn”. <br>14a. Admin chọn khóa học đã có học phí. <br>Usecase tiếp tục từ bước 14 đến bước 18.|
| Exception Flow | 13a. Hệ thống phát hiện học phí nhỏ hơn hoặc bằng 0 và hiển thị thông báo "Học phí phải lớn hơn 0!", quay lại bước 15 usecase.<br>13b. Hệ thống phát hiện phương thức thanh toán bị bỏ trống và hiển thị thông báo “Vui lòng thêm phương thức thanh toán! ”, quay lại bước 8 usecase. |
## 8.3. ERD Diagram
