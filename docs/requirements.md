...
| Main Flow | <ol><li>Admin truy cập chức năng Quản lý khóa học</li><li>Hệ thống hiển thị danh sách khóa học</li><li>Admin chọn khóa học cần sắp xếp lịch học.</li><li>Hệ thống hiển thị các lớp có trong danh sách, danh sách giáo viên giảng dạy.</li><li>Admin chọn lớp học cần sắp xếp.</li><li>Hệ thống hiển thị thông tin chi tiết: mã lớp, tên lớp, khóa học, trạng thái hoạt động.</li><li>Admin nhấn “Thêm”.</li><li>Hệ thống hiển thị các thông tin: ngày học, thời gian bắt đầu, thời gian kết thúc, giờ bắt đầu, giờ kết thúc, phòng học, giáo viên (thông tin không bắt buộc).</li><li>Admin nhập thông tin buổi học.</li><li>Admin nhấn “Lưu”.</li><li>Hệ thống kiểm tra dữ liệu:<ul><li>Không để trống thông tin.</li><li>Thời gian kết thúc lớn hơn thời gian bắt đầu</li><li>Giờ kết thúc lớn hơn giờ bắt đầu</li></ul></li><li>Hệ thống kiểm tra trùng lịch:<ul><li>Phòng học bị trùng</li></ul></li><li>Nếu thông tin hợp lệ, hệ thống lưu buổi học.</li><li>Hệ thống thông báo “Hoàn tất”.</li><li>Hệ thống cập nhật danh sách buổi học của lớp.</li><li>Hệ thống hiển thị buổi học đã được thêm vào danh sách.</li><li>Admin tiếp tục thêm các buổi học khác cho lớp.</li><li>Sau khi hoàn thành, hệ thống cấp nhật lịch học trên trang đăng ký.</li><li>Hệ thống tự động cập nhật thông tin giáo viên vào lớp học đã đăng ký.</li></ol> |
| Alternative Flow | 16a. Admin chọn một buổi học đã tồn tại trong danh sách.<br>Usecase tiếp tục từ bước 7 tới bước 16, 18.<br>16b. Admin chọn một buổi học đã tồn tại trong danh sách.<br>-Admin nhấn “Xoá”<br>-Hệ thống hiển thị thông báo xác nhận xóa buổi học.<br>- Admin xác nhận thao tác xóa.<br>- Hệ thống xóa buổi học khỏi lớp học.<br>- Hệ thống cập nhật lại danh sách lịch học của lớp.<br>- Hệ thống hiển thị thông báo “Hoàn tất”. |
| Exception Flow | 11a. Hệ thống phát hiện thông tin bắt buộc chưa được nhập và hiển thị “ Vui lòng nhập thông tin đầy đủ”, quay lại bước 9 usecase.<br>11b. Hệ thống phát hiện giờ bắt đầu lớn hơn giờ kết thúc và hiển thị “ Giờ bắt đầu phải nhỏ hơn giờ kết thúc!”, quay lại bước 9 usecase.<br>11c. Hệ thống phát hiện giờ kết thúc nhỏ hơn giờ bắt đầu và hiển thị “ Giờ bắt đầu phải nhỏ hơn giờ kết thúc!”, quay lại bước 9 usecase.<br>11d. Hệ thống phát hiện ngày bắt đầu lớn hơn ngày kết thúc và hiển thị “Ngày bắt đầu phải nhỏ hơn ngày kết thúc!”, quay lại bước 9 usecase.<br>11e. Hệ thống phát hiện ngày kết thúc nhỏ hơn ngày bắt đầu và hiển thị “Ngày bắt đầu phải nhỏ hơn ngày kết thúc!”, quay lại bước 9 usecase.<br>12a. Hệ thống phát hiện phòng học bị sắp xếp trong cùng khung giờ và hiển thị “Phòng học đã được sử dụng.”, quay lại bước 9 usecase. |
...
| Actor | Admin |
| Description | Admin thiết lập mức học phí cho các khóa học và cấu hình các chính sách liên quan như phương thức thanh toán, quy định thanh toán chi tiết cho các khóa học. |
| Pre-Condition(s) | Admin đã đăng nhập hệ thống<br>Hệ thống đã tồn tại các khóa học cần được cấu hình học phí và chính sách. |
| Post-Condition(s) | Thông tin học phí của khóa học được cập nhật thành công trong hệ thống.<br>Chính sách thanh toán được lưu vào hệ thống.<br>Cấu hình này sẽ được áp dụng khi sinh viên đăng ký khóa học. |
| Main Flow | <ol><li>Admin truy cập chức năng Cấu hình học phí.</li><li>Hệ thống hiển thị danh sách các khóa học.</li><li>Admin chọn khóa học cần thiết lập học phí.</li><li>Hệ thống hiển thị thông tin: mã khóa học, tên khóa học, học phí, phương thức thanh toán.</li><li>Admin chọn nút “Chỉnh sửa”.</li><li>Admin nhập mức học phí, phương thức thanh toán cho khóa học.</li><li>Admin nhấn “Chính sách”.</li><li>Admin cấu hình chính sách học phí:<ul><li>Học phí bắt buộc lớn hơn 0.</li><li>Bắt buộc thanh toán toàn bộ các khóa học dưới 5 triệu VNĐ.</li><li>Cho phép thanh toán một phần các khóa học trên 5 triệu đồng.</li></ul></li><li>Admin thiết lập các quy định thanh toán:<ul><li>Dưới 5 triệu VNĐ, số tiền thanh toán phải tối đa.</li><li>Trên 5 triệu VNĐ, số tiền thanh toán tối thiểu.</li><li>Thời hạn thanh toán phần còn lại trước khai giảng 3 ngày.</li></ul></li><li>Admin nhấn “Thêm phương thức thanh toán”.</li><li>Admin cấu hình chính sách thanh toán:<ul><li>Thanh toán qua ngân hàng.</li><li>Thanh toán qua ví điện tử (Momo, Zalopay, Shopeepay).</li><li>Thanh toán qua thẻ tín dụng/ghi nợ.</li></ul></li><li>Admin nhấn “Lưu”.</li><li>Hệ thống kiểm tra dữ liệu hợp lệ.</li><li>Hệ thống lưu cấu hình học phí và chính sách vào hệ thống.</li><li>Hệ thống hiển thị thông báo “Thành công”.</li></ol> |
| Alternative Flow | 14a. Admin chọn khóa học đã được cấu hình học phí và chính sách.<br>Usecase tiếp tục từ bước 4 đến bước 15.<br>14b. Admin chọn khóa học đã được cấu hình học phí và chính sách, nhấn “Hủy”<br>-Hệ thống hiển thị thông báo “Xác nhận hủy?”<br>-Admin nhấn “Xác nhận”<br>-Hệ thống xóa cấu hình học phí và chính sách. |
| Exception Flow | 13a. Hệ thống phát hiện học phí nhỏ hơn hoặc bằng 0 và hiển thị thông báo "Học phí phải lớn hơn 0!", quay lại bước 8 usecase.<br>13b. Hệ thống phát hiện phương thức thanh toán bị bỏ trống và hiển thị thông báo “Vui lòng thêm phương thức thanh toán! ”, quay lại bước 10 usecase. |
## 8.3. ERD Diagram
